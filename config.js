...
global.owner = [
   ...
   ['', 'Gestion White', true],
   ['50240447765', 'Dev nicki', true],
   ['50760276493', 'Dev Alter knigth', true],
   ['50368471855', 'Dev Meliodas', true],
   ['', 'Dev Prak', true],
   ['', 'Dev Darkcore', true],
   ['', 'Gestion Morales', true],
   ['', 'CrowBot OFC1', true],
   ['', 'Gestion Mateo', true],
   ['', 'Gestion Sha', true],
]
...
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
global.mashach = 'https://chat.whatsapp.com/CJro5DyQHUu7tk20iXpZIa'
global.mashac = 'wa.me/51920227615*/n• *wa.me/5224312686*/n• *wa.me/51920227615*'
global.repobot = 'https://github.com/WillZek/CrowBot-ST'
global.grupo = 'https://chat.whatsapp.com/H5UC1FBtT0pI2YjJZ6zipB'
global.comu = 'https://chat.whatsapp.com/H5UC1FBtT0pI2YjJZ6zipB'
global.channel = 'https://whatsapp.com/channel/0029Vaz6RTR0LKZIKwudX32x'
global.yt = 'https://youtube.com/@seishironagi-j6e?si=aVdyvu0higOafMey'
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
